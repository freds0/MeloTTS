...
if __name__ == "__main__":
    from .pt_to_ipa import pt2ipa
    import json

    e = Gruut(language="pt", keep_puncs=True, keep_stress=True, use_espeak_phonemes=True)
    symbols = [
        "_",
        ",",
        ".",
    ...
    with open('./text/pt_phonemizer/portuguese_text.txt', 'r') as f:
        lines = f.readlines()
    ...
    with open('./text/pt_phonemizer/pt_symbols.txt', 'w') as g:
        g.writelines(symbols + not_existed_sym)
        
    with open('./text/pt_phonemizer/example_ipa.txt', 'w') as g:
        g.writelines(phonemes)
        
    data = {'symbols': symbols + not_existed_sym}
    with open('./text/pt_phonemizer/pt_symbols_v2.json', 'w') as f:
